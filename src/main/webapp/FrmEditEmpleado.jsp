...
<form name="form" method="get" action="UpdateEmpleado.action"> 
    <div class="modal-body">
        <div class="form-group">
            <label class="h5 font-weight-bold text-dark" for="empleadoId">Id:</label>
            <s:textfield cssClass="form-control" name="empleadoId" value="%{empleado.empleadoId}" />            
        </div>
        <div class="form-group">
            ...
            <small id="CartHelp" class="form-text text-muted" >El numero de nomina, ej:50102030</small>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="h5 font-weight-bold text-dark" for="puestoId">Puesto:</label>
             <s:select name="puestoId" cssClass="form-control mr-sm-2"  
                              ...
                              value="empleado.getTblPuestos().getPuestoId()" headerValue="empleado.getTblPuestos().getPuestoNombre()"/>                   
        </div>
        <div class="form-group">
