...
<form action="InsertBitaMov.action">
    ...
    <div class="modal-body form-inline">
        <s:push value="tblbitamov">
            <div class="form-group col-4 my-2">
                ...
                <s:textfield name="bitmovaFecha" class="form-control col-lg-12" type="date" format="yyyy-MM-dd" value="%{fenvio}" required="true"/>
            ...
            <div class="form-group col-4 my-2">
                ...
                <s:textfield name="bitmovaActivo" class="form-control" required="true"/>            
            ...
            <div class="form-group col-4 my-2" id="Seriediv">
                ...
                <s:textfield name="bitmovaMotivo" class="form-control" required="true"/>            
                <div class="invalid-tooltip">
                    Por favor escribe el motivo del mov. de activo.
                </div>
            </div> 
            ...
            <div class="form-group col-8 my-2" id="Seriediv">
                ...
                <s:textarea name="bitmovaSerie" class="form-control col-lg-12" required="true" />                           
                <div class="invalid-tooltip">
